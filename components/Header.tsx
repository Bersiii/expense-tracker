...
const Header = () => {
  return (
    <header className="w-full px-6 pt-4">
      <nav className="mx-auto flex h-[64px] max-w-[1200px] items-center justify-between rounded-2xl border border-gray-200 bg-white/90 px-6 shadow-sm backdrop-blur-md">
        {/* Logo */}
        ...
        <details className="relative">
          <summary className="cursor-pointer list-none rounded-full border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-800 shadow-sm transition hover:border-orange-300 hover:text-orange-500">
